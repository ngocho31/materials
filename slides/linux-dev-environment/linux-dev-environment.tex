...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}[t]{0.3\textwidth}
      \includegraphics[width=0.9\textwidth]{common/pictures/ubuntu.pdf}\\
...
\begin{frame}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.7\textwidth]{slides/linux-dev-environment/host-vs-target.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \item Example for using the simplest of them: {\em Picocom}
    \begin{itemize}
