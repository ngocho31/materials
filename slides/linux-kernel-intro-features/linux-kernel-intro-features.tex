\subsection{Overral and features}
...
\begin{columns}
  ...
  \end{itemize}
  \column{0.2\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-kernel-intro-features/linus-torvalds.jpg}
    \scriptsize
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[height=0.8\textheight]{slides/linux-kernel-intro-features/linux-kernel-in-system.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{itemize}
    \column{0.3\textwidth}
      \includegraphics[width=\textwidth]{slides/linux-kernel-intro-features/system-calls.pdf}
      \scriptsize
      Image credits (Wikipedia):\\
