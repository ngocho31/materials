...
\begin{frame}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{slides/linux-app-debugging/gdb-vs-gdbserver.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=\textwidth]{slides/linux-app-debugging/gdb-vs-gdbserver-architecture.pdf}
  \end{center}
\end{frame}
