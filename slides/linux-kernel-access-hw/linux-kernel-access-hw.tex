...
\begin{frame}{Why kernel modules?}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.3\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-kernel-access-hw/modules-to-access-rootfs.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Module alias: {\em modules.alias}}
  \begin{center}
    \includegraphics[width=\textwidth]{slides/linux-kernel-access-hw/module-alias-usage.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{Device Tree: from source to blob}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.3\textwidth}
    \includegraphics[height=0.7\textheight]{slides/linux-kernel-access-hw/dts-to-dtb.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Device Tree: using the blob}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.4\textwidth}
    \includegraphics[height=0.8\textheight]{slides/linux-kernel-access-hw/ram.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Device Tree base syntax}
  \begin{columns}
    ...
    \column{0.5\textwidth}
    \begin{center}
      \includegraphics[height=0.6\textheight]{slides/linux-kernel-access-hw/dt-basic-syntax.pdf}
    \end{center}
  \end{columns}
\end{frame}
...
\end{minted}
    ...
    \end{onlyenv}
    \column{0.4\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-kernel-access-hw/simple-hardware.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Device Tree inheritance example}
  \begin{center}
    \includegraphics[width=\textwidth]{slides/linux-kernel-access-hw/dt-inheritance.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{DT inheritance in STM32MP1 support}
  \begin{center}
    \includegraphics[height=0.8\textheight]{slides/linux-kernel-access-hw/dt-inheritance-stm32.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{Device Tree specifications}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.3\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-kernel-access-hw/dt-spec.png}
  \end{columns}
\end{frame}
...
\begin{frame}{{\tt compatible} property and Linux kernel drivers}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.4\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-kernel-access-hw/dt-to-devices.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Pin-muxing description}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.5\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-kernel-access-hw/pin-muxing-principle.pdf}
  \end{columns}
\end{frame}
...
\begin{onlyenv}<2>
  \begin{center}
    \includegraphics[height=0.78\textheight]{slides/linux-kernel-access-hw/stm32mp157-i2c-pin-mux.png}
  \end{center}
  \tiny
...
\end{block}
  \column{0.5\textwidth}
  \begin{center}
    \includegraphics[height=0.3\textheight]{slides/linux-kernel-access-hw/cn14-pinout.png}\\
    \vspace{0.5cm}
    \includegraphics[height=0.3\textheight]{slides/linux-kernel-access-hw/led-on.jpg}
  \end{center}
  \end{columns}
\end{frame}
...
\end{block}
  \column{0.5\textwidth}
  \begin{center}
    \includegraphics[width=\textwidth]{slides/linux-kernel-access-hw/cn13-pinout.png}\\
    \includegraphics[width=0.4\textwidth]{slides/linux-kernel-access-hw/bme.jpg}
  \end{center}
\end{columns}
\vspace{0.5cm}
Details at
