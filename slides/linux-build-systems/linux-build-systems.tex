...
\begin{frame}{Embedded Linux build system: principle}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{slides/linux-build-systems/buildsystem-principle.pdf}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Build systems vs. Embedded Linux build systems}
  \begin{columns}
    ...
    \column{0.4\textwidth}
    \begin{center}
      \includegraphics[height=0.8\textheight]{slides/linux-build-systems/build-system-vs-embedded-linux-build-system.pdf}
    \end{center}
  \end{columns}
\end{frame}
...
\begin{frame}{Buildroot: introduction}
  \begin{columns}
    \column{0.2\textwidth}
    \includegraphics[height=\textwidth,angle=90]{slides/linux-build-systems/buildroot-logo.png}
    \column{0.8\textwidth}
    \begin{itemize}
...
\begin{frame}{Buildroot: configuration and build}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.4\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-build-systems/buildroot-screenshot.png}
  \end{columns}
\end{frame}
...
\begin{frame}{Buildroot resources}
  \begin{columns}
    ...
    \column{0.4\textwidth}
    \begin{center}
      \includegraphics[height=0.4\textheight]{slides/linux-build-systems/br-site.png}\\
      \includegraphics[height=0.4\textheight]{slides/linux-build-systems/br-training.png}
    \end{center}
  \end{columns}
\end{frame}
...
\begin{frame}{Yocto Project / OpenEmbedded}
  ...
  \end{itemize}
  \column{0.4\textwidth}
  \includegraphics[width=\textwidth]{slides/linux-build-systems/yp-diagram-overview.png}
\end{columns}
\end{frame}

\begin{frame}{Yocto Project overview}
  \begin{center}
    \includegraphics[width=\textwidth]{slides/linux-build-systems/yp-how-it-works-new-diagram.png}
  \end{center}
\end{frame}
...
\begin{frame}{Yocto resources}
  \begin{columns}
    ...
    \column{0.4\textwidth}
    \begin{center}
      \includegraphics[height=0.4\textheight]{slides/linux-build-systems/yp-docs.png}\\
      \includegraphics[height=0.4\textheight]{slides/linux-build-systems/yp-training.png}
    \end{center}
  \end{columns}
\end{frame}
