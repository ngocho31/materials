...
\begin{frame}{Target and staging spaces}
  ...
  \item Indeed, we want the root filesystem on the target to be as
    minimal as possible.
  \end{itemize}
  \includegraphics[width=\textwidth]{slides/linux-cross-compiling-user-space/source-build-target-spaces.pdf}
\end{frame}
...
\begin{frame}{automake / autoconf / autoheader}
  \begin{center}
    \includegraphics[height=0.8\textheight]{slides/linux-cross-compiling-user-space/autotools.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{Distinction between {\em prefix} and {\em DESTDIR}}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.5\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-cross-compiling-user-space/destdir-and-prefix.pdf}
  \end{columns}
\end{frame}
