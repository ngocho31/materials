...
\begin{frame}{D-Bus}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.2\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/dbus.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Linux graphics stack overview}
  \begin{center}
    \includegraphics[height=0.85\textheight]{slides/linux-software-stacks/graphics-stack.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{Concept of display servers}
  \begin{columns}
    ...
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/display-server.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{X11 and X.org}
  \begin{columns}[T]
    ...
    \end{itemize}
    \column{0.2\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/xorg.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Wayland}
  \begin{columns}[T]
    ...
    \end{itemize}
    \column{0.2\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/wayland.png}
  \end{columns}
\end{frame}
...
\begin{frame}{Concept of graphics toolkits}
  \begin{columns}
    ...
    \column{0.3\textwidth}
    \begin{center}
      \includegraphics[height=0.8\textheight]{slides/linux-software-stacks/toolkit.pdf}
    \end{center}
  \end{columns}
\end{frame}
...
\begin{frame}{Qt}
  ...
  \end{itemize}
  \column{0.3\textwidth}
  \includegraphics[width=\textwidth]{slides/linux-software-stacks/qt-logo.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Gtk}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.2\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/gtk-logo.png}
  \end{columns}
\end{frame}
...
\begin{frame}{Flutter}
  \begin{columns}
    ...
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/Google-flutter-logo.pdf}\\
    \vspace{0.5cm}
    % Source: https://flutter.dev
    \includegraphics[width=0.9\textwidth]{slides/linux-software-stacks/flutter-app.png}
  \end{columns}
\end{frame}
...
\begin{frame}{SDL}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.2\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/sdl-logo.png}
  \end{columns}
\end{frame}
...
\begin{frame}{Linux multimedia stack overview}
  \begin{center}
    \includegraphics[height=0.85\textheight]{slides/linux-software-stacks/multimedia-stack.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{GStreamer}
  ...
  \begin{center}
    \includegraphics[width=0.6\textwidth]{slides/linux-software-stacks/gstreamer-pipeline.png}
  \end{center}
\end{frame}
...
\begin{frame}{Further details on Linux graphics and multimedia stacks}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.4\textwidth}
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/linux-graphics-course-slide.jpg}
    \includegraphics[width=\textwidth]{slides/linux-software-stacks/linux-audio-course-slide.jpg}
  \end{columns}
\end{frame}
...
\begin{frame}{Linux networking stack}
  \begin{center}
    \includegraphics[height=0.85\textheight]{slides/linux-software-stacks/networking-stack.pdf}
  \end{center}
\end{frame}
